...
//  DesignCode
//
//  Created by Angshuman Das on 6/28/23.
//
...
struct BottomCardView: View {
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("This certificate is proof that Angshuman has acheivedthe ui design course with approval from Design+Code instructor.")
